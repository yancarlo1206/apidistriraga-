...
public class CotizacionEstadoController {
	...
	private CotizacionEstadoService cotizacionEstadoService;
	 ...
	 @PostMapping
		public ResponseEntity<Responses<?>> guardar(@Valid @RequestBody CotizacionEstado request, BindingResult bindingResult) {
			...
			try {
				...
				return ResponseEntity.ok(new Responses<>("Estado de cotizacion creado correctamente", HttpStatus.OK.value(), creado));
			} catch (Exception e) {
		...
		public ResponseEntity<Responses<?>> actualizar(@PathVariable Integer id, @Valid @RequestBody CotizacionEstado request,
		...
		public ResponseEntity<String> eliminar(@PathVariable Integer id) {
			...
			if (eliminado) {
				return ResponseEntity.ok("estado de cotizacion con ID:" + id + " eliminado correctamente");
			} else {
				return ResponseEntity.status(HttpStatus.NOT_FOUND).body("estado de cotizacion con ID:" + id + "no encontrado");
			}
